    ...
    const init = async () => {
      if (typeof window !== "undefined" && window.ethereum) {
        try {
          ...
          const abi = [
            {
              inputs: [{ internalType: "uint256", name: "cInd", type: "uint256" }],
              name: "vote",
              outputs: [],
        ...
        Alert.alert("MetaMask is required!", "Please install MetaMask to vote.");
      }
    };
...
const styles = StyleSheet.create({
  ...
  backButton: { backgroundColor: Colors.PRIMARY, paddingVertical: 8, paddingHorizontal: 15, borderRadius: 8 },
  backButtonText: { fontSize: 16, color: "#fff", fontWeight: "bold" },
  subHeader: { fontSize: 18, textAlign: "center", marginVertical: 10 },
  candidateContainer: { flexDirection: "row", alignItems: "center", backgroundColor: "#f5f5f5", padding: 10, marginVertical: 5, borderRadius: 8 },
  selectedCandidate: { backgroundColor: Colors.LightBlue },
  candidateImage: { width: 50, height: 50, borderRadius: 25, marginRight: 10 },
  candidateText: { fontSize: 18, fontWeight: "bold" },
  voteButton: { marginTop: 20, backgroundColor: Colors.PRIMARY, padding: 15, borderRadius: 8, alignItems: "center" },
  voteButtonText: { fontSize: 18, color: "#fff", fontWeight: "bold" },
  confirmationText: { fontSize: 20, color: "green", textAlign: "center", fontWeight: "bold", marginTop: 50 },
